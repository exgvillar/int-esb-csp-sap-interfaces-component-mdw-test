...
public class ZCRMCV_E007_EXTRACTDATA_AB2_ProxyImpl implements IStandardSAPProxy {

	private static Log log = LogFactory.getLog( ZCRMCV_E007_EXTRACTDATA_AB2_ProxyImpl.class );
	
	public ZCRMCV_E007_EXTRACTDATA_AB2_ProxyImpl() {
		super();		
	}
	...
	public ArrayList<IProxyOutputData> executeRemoteFunction( JCoDestination destination, ArrayList<ProxyInputParameter> inputParamtersList) throws Exception {
		...
		try {
			...
			ft = destination.getRepository().getFunctionTemplate( "ZCRMCV_E007_EXTRACTDATA_AB2" );
			if(ft == null)
