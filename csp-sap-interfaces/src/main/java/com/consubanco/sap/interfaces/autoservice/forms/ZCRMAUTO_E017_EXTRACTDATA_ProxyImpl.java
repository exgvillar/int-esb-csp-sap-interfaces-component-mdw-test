...
import com.consubanco.sap.interfaces.cxn.forms.ZCRMCV_E007_EXTRACTDATA_AB_OutputData;
 ...
 *
 */
public class ZCRMAUTO_E017_EXTRACTDATA_ProxyImpl implements IStandardSAPProxy {

	private static Log log = LogFactory.getLog( ZCRMAUTO_E017_EXTRACTDATA_ProxyImpl.class );
	
	/**
	 * 
	 */
	public ZCRMAUTO_E017_EXTRACTDATA_ProxyImpl() {
	}
...
try {
			...
			ft = destination.getRepository().getFunctionTemplate( "ZCRMAUTO_E017_EXTRACTDATA" );
			if(ft == null)
				throw new RuntimeException("ZCRMAUTO_E017_EXTRACTDATA not found in SAP.");
			...
			log.error(" executing function " + "ZCRMAUTO_E017_EXTRACTDATA" , e);
			throw e;
		} finally {
