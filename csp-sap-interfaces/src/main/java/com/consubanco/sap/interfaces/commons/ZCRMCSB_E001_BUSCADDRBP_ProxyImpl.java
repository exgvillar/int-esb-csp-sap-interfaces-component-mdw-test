...
import com.sap.tc.logging.schema.CommonCategory;

public class ZCRMCSB_E001_BUSCADDRBP_ProxyImpl implements IStandardSAPProxy {

	private static Log log = LogFactory.getLog( ZCRMCSB_E001_BUSCADDRBP_ProxyImpl.class );
	
	
	public ZCRMCSB_E001_BUSCADDRBP_ProxyImpl() {
		super();		
	}
	...
	public ArrayList<IProxyOutputData> executeRemoteFunction( JCoDestination destination, ArrayList<ProxyInputParameter> inputParamtersList) throws Exception {
		...
		try {
			...
			ft = destination.getRepository().getFunctionTemplate( "ZCRMCSB_E001_BUSCADDRBP" );
			if(ft == null)
				throw new RuntimeException("ZCRMCSB_E001_BUSCADDRBP not found in SAP.");
			...
			for (int i = 0; i < data.getNumRows(); i++, data.nextRow() ) {
				ZCRMCSB_E001_BUSCADDRBP_OutputData tableData = new ZCRMCSB_E001_BUSCADDRBP_OutputData();
			...
			log.error(" executing function " + "ZCRMCSB_E001_BUSCADDRBP" , e);
			throw e;
		} finally {
