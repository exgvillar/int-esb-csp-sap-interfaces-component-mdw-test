 ...
 *
 */
public class ZCRMORI_E005_BUSCADDRBP_OutputData implements Serializable,
		IProxyOutputData {
	...
	private ArrayList<ZCRMORI_E005_PHONE_OutputData> phones = null;
	
	
	/**
	 * 
	 */
	public ZCRMORI_E005_BUSCADDRBP_OutputData() {
		super();
	}
	 ...
	 * @return the phones
	 */
	public ArrayList<ZCRMORI_E005_PHONE_OutputData> getPhones() {
		return phones;
	}
	 ...
	 */
	public void setPhones(ArrayList<ZCRMORI_E005_PHONE_OutputData> phones) {
		this.phones = phones;
	}
	...
	public void addPhone(String number, String extension, String phoneType){
		if(this.phones == null){
			this.phones = new ArrayList<ZCRMORI_E005_PHONE_OutputData>();
		}
		ZCRMORI_E005_PHONE_OutputData phone = new ZCRMORI_E005_PHONE_OutputData();
