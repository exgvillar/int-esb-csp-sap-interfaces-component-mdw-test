 ...
 * 
 */
public class ZCRMRECO_P011_PDSO_I610_ProxyImpl implements IStandardSAPProxy {

	private static Log log = LogFactory.getLog( ZCRMRECO_P011_PDSO_I610_ProxyImpl.class );
	...
	public ArrayList<IProxyOutputData> executeRemoteFunction( JCoDestination destination, ArrayList<ProxyInputParameter> inputParamtersList) throws Exception {
		...
		try {
			...
			ft = destination.getRepository().getFunctionTemplate( "ZCRMRECO_P011_PDSO_I610" );
			if(ft == null)
				throw new RuntimeException("ZCRMRECO_P011_PDSO_I610 not found in SAP.");
			...
			ZCRMRECO_P011_PDSO_I610_OutputData data = new ZCRMRECO_P011_PDSO_I610_OutputData();
			...
			log.error(" executing function " + "ZCRMRECO_P011_PDSO_I610 :: ", e);
			throw e;
		} finally {
