...
public class ZCRMLCOM_E001_READLCOM_XSTATUS_ProxyImpl  {

	private static Log log = LogFactory.getLog( ZCRMLCOM_E001_READLCOM_XSTATUS_ProxyImpl.class );
	
	private final String RFC_NAME = "ZCRMLCOM_E001_READLCOM_XSTATUS";
	
	public ZCRMLCOM_E001_READLCOM_XSTATUS_ProxyImpl() {
		super();		
	}
