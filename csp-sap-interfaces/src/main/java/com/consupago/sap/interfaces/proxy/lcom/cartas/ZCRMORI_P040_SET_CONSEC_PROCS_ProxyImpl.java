...
public class ZCRMORI_P040_SET_CONSEC_PROCS_ProxyImpl  {

	private static Log log = LogFactory.getLog( ZCRMORI_P040_SET_CONSEC_PROCS_ProxyImpl.class );
	
	private final String RFC_NAME = "ZCRMORI_P040_SET_CONSEC_PROCS";
	
	public ZCRMORI_P040_SET_CONSEC_PROCS_ProxyImpl() {
		super();		
	}
