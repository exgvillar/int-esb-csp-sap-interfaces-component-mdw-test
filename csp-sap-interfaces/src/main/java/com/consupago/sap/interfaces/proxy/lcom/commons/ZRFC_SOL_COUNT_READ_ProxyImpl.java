...
public class ZRFC_SOL_COUNT_READ_ProxyImpl  {
	private static Log log = LogFactory.getLog( ZRFC_SOL_COUNT_READ_ProxyImpl.class );
	
	private final String RFC_NAME = "ZRFC_SOL_COUNT_READ";
	
	public ZRFC_SOL_COUNT_READ_ProxyImpl() {
		super();		
	}

	public int  executeRemoteFunction( JCoDestination destination, ArrayList<ProxyInputParameter> inputParamtersList) throws Exception {
		...
		try {
			...
			int regreso = function.getExportParameterList().getInt("E_CONTADOR");
