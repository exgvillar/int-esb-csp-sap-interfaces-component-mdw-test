...
public class ZCRMTESO_P002_DELETEUPDT_TABLE_ProxyImpl {

	private static Log log = LogFactory.getLog( ZCRMTESO_E001_INFO_FORMALIZA_ProxyImpl.class );
	
	private final String RFC_NAME = "ZCRMTESO_P002_DELETEUPDT_TABLE";
	
	public ZCRMTESO_P002_DELETEUPDT_TABLE_ProxyImpl() {
		super();		
	}
