...
public class ZRFC_DATOS_BP_ProxyImpl implements IStandardSAPProxy {

	private static Log log = LogFactory.getLog( ZRFC_DATOS_BP_ProxyImpl.class );
	
	public ZRFC_DATOS_BP_ProxyImpl() {
		super();		
	}
	...
	public ArrayList<IProxyOutputData> executeRemoteFunction( JCoDestination destination, ArrayList<ProxyInputParameter> inputParamtersList) throws Exception {
		...
		try {
			...
			ft = destination.getRepository().getFunctionTemplate("ZRFC_DATOS_BP");
			if(ft == null)
	            throw new RuntimeException("ZRFC_DATOS_BP not found in SAP.");
			...
			log.error(" executing function " + "ZRFC_DATOS_BP" , e);
			throw e;
		} finally {
