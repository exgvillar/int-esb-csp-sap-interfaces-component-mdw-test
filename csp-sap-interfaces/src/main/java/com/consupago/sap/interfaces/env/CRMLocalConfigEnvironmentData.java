package com.consupago.sap.interfaces.env;
 ...
 *
 */
public class CRMLocalConfigEnvironmentData {
	private static CRMLocalConfigEnvironmentData singleton = null;
	...
	private CRMLocalConfigEnvironmentData(){}
	
	
	

	public static CRMLocalConfigEnvironmentData instance() {
		log.info("Creation of DestinationDataProvider");
		MyDestinationDataProvider myProvider = new MyDestinationDataProvider();
		if ( !com.sap.conn.jco.ext.Environment.isDestinationDataProviderRegistered() ){
			com.sap.conn.jco.ext.Environment.registerDestinationDataProvider(myProvider);
			myProvider.changePropertiesForABAP_AS(CRMLocalConfigEnvironmentData.createProps("sap-erp.config","CSPSAPERP"));
			myProvider.changePropertiesForABAP_AS(CRMLocalConfigEnvironmentData.createProps("sap-crm.config","CSPSAPCRM"));
		}
		if (singleton == null){
			singleton = new CRMLocalConfigEnvironmentData();
		}
	...
	private static Properties createProps(String fileName, String sapId){
		...
		if( inStream == null ) inStream = CRMLocalConfigEnvironmentData.class.getClassLoader().getResourceAsStream( fileName );
		try {
			log.info("Properties file : " + inStream );
	...
	public static void main(String[] args) throws Exception {
		CRMLocalConfigEnvironmentData prov = CRMLocalConfigEnvironmentData.instance();
