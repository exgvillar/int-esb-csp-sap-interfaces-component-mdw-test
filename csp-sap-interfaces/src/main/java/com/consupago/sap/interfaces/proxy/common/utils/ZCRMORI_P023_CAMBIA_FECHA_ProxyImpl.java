...
public class ZCRMORI_P023_CAMBIA_FECHA_ProxyImpl {

	private static Log log = LogFactory.getLog( ZCRMORI_P023_CAMBIA_FECHA_ProxyImpl.class );
	
	private final String RFC_NAME = "ZCRMORI_P023_CAMBIA_FECHA";
	
	public ZCRMORI_P023_CAMBIA_FECHA_ProxyImpl() {
		super();		
	}
