...
public class ZCRMLCOM_P005_CHANGE_STATUS_ProxyImpl  {
	private static Log log = LogFactory.getLog( ZCRMLCOM_P005_CHANGE_STATUS_ProxyImpl.class );
	
	private final String RFC_NAME = "ZCRMLCOM_P005_CHANGE_STATUS";
	
	public ZCRMLCOM_P005_CHANGE_STATUS_ProxyImpl() {
		super();		
	}
