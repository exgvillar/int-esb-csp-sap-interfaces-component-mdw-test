 ...
 * 
 */
public class ZCRMRECO_P005_UPDSTS_SO_RECO_ProxyImpl_TC extends TestCase {

	private static Log log = LogFactory
			.getLog(ZCRMRECO_P005_UPDSTS_SO_RECO_ProxyImpl_TC.class);

	/**
	 * 
	 */
	public ZCRMRECO_P005_UPDSTS_SO_RECO_ProxyImpl_TC() {
	 ...
	 * @param name
	 */
	public ZCRMRECO_P005_UPDSTS_SO_RECO_ProxyImpl_TC(String name) {
		super(name);
